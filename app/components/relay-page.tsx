  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f7f7f5] p-5">
      <section className="w-full max-w-lg rounded-[26px] border border-[#deded8] bg-white p-8 text-center shadow-[0_18px_60px_rgba(30,40,34,0.07)] sm:p-12">
        ...
        <p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-[#707069]">Sign in to open events shared with you, claim outreach batches, and connect Gmail when you are ready to send.</p>
        ...
        <p className="mt-4 text-xs leading-5 text-[#92928b]">No signup form or password is required. Your Relay profile is created automatically, and event access comes only from an organizer’s link.</p>
      </section>
    </main>
  );
}
